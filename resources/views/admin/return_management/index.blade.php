...
@section('content')
<header class="mb-8">
    <h1 class="text-3xl font-playfair font-bold text-gray-900">Returns & Refunds</h1>
    <p class="text-sm text-gray-600 mt-1">Review customer refund requests and resolve them with notes.</p>
</header>

<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="bg-white border border-gray-200 rounded-2xl p-5">
        <p class="text-xs uppercase tracking-wide text-gray-500 font-semibold">Total Requests</p>
    ...
    <div class="bg-white border border-green-200 rounded-2xl p-5">
        ...
        <p class="text-3xl font-bold text-green-600 mt-2">{{ number_format($stats['approved'] ?? 0) }}</p>
    </div>
    <div class="bg-white border border-red-200 rounded-2xl p-5">
        ...
        <p class="text-3xl font-bold text-red-500 mt-2">{{ number_format($stats['rejected'] ?? 0) }}</p>
    </div>
</div>
