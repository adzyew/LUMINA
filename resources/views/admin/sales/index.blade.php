...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <article class="rounded-3xl border border-orange-200 bg-gradient-to-br from-orange-50 to-white p-5 shadow-sm">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <section class="xl:col-span-2 bg-white border border-gray-200 rounded-3xl p-5 shadow-sm">
        ...
        <section class="bg-white border border-gray-200 rounded-3xl p-5 shadow-sm">
            ...
            @if(count($paymentMixSeries) > 0)
                <div id="paymentMixChart" class="min-h-[300px]"></div>
            @else
                <div class="min-h-[300px] flex items-center justify-center text-sm text-gray-500 border border-dashed border-gray-200 rounded-2xl">
