                        ...
                        <td class="px-4 py-4 align-top">
                            <div class="grid grid-cols-2 gap-2">
                                <form method="POST" action="{{ route('admin.feedback.approve', $review) }}">
                                    @csrf
                                    @method('PATCH')
                                    <button class="w-full rounded-lg bg-green-600 hover:bg-green-500 text-white px-3 py-2 text-xs font-semibold">
                                ...
                                <form method="POST" action="{{ route('admin.feedback.flag', $review) }}">
                                    ...
                                    <button class="w-full rounded-lg bg-blue-600 hover:bg-blue-500 text-white px-3 py-2 text-xs font-semibold">{{ $review->is_flagged ? 'Unflag' : 'Flag' }}
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5" />
                                        </svg></button>
                                </form>

                                <button type="button" class="col-span-1 w-full rounded-lg bg-red-600 hover:bg-red-500 text-white px-3 py-2 text-xs font-semibold" onclick="openModerationReasonModal('{{ route('admin.feedback.reject', $review) }}', 'Reject Review', 'Please provide the reason for rejecting this review.')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                                </button>

                                <button type="button" class="col-span-1 rounded-lg bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 text-xs font-semibold" onclick="openModerationReasonModal('{{ route('admin.feedback.remove', $review) }}', 'Remove Review', 'Please provide the reason for removing this review from public listing.')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
