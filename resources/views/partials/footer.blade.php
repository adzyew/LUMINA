<footer id="contact" class="bg-amber-50 dark:bg-black border-t border-amber-200/50 dark:border-white/10 pt-16 pb-8 transition-colors">
    <div class="container mx-auto px-4 sm:px-6">
        ...
        <div class="mt-16 pt-8 border-t border-amber-200/50 dark:border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p class="text-amber-900/70 dark:text-gray-500 text-xs text-center sm:text-left">&copy; {{ date('Y') }} Lumina Jewelry Accessories. All rights reserved.</p>
        </div>
    </div>
</footer>