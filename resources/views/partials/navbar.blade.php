                ...
                @auth
                    ...
                    <div class="relative" id="userDropdownWrapper">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-2 w-56 rounded-xl bg-white dark:bg-gray-900 shadow-xl border border-gray-200 dark:border-white/10 py-1 z-50 transition-opacity duration-150">
                            ...
                            <a href="{{ route('orders.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                            ...
                            <a href="{{ route('profile.show') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
            ...
            <div class="flex flex-col space-y-1">
                ...
                <div class="pt-3 mt-3 border-t border-gray-200 dark:border-white/10 space-y-1">
                 @auth   
                        ...
                        <a href="{{ route('orders.index') }}" class="flex items-center gap-3 px-4 py-3 text-inherit hover:text-amber-500 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">Orders</a>
                        <a href="{{ route('profile.show') }}" class="flex items-center gap-3 px-4 py-3 text-inherit hover:text-amber-500 hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">Settings</a>
