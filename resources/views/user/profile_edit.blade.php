    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-10 py-12 max-w-7xl">
        <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h1 class="text-3xl font-playfair font-bold text-gray-900">Profile Settings</h1>
                    <p class="text-gray-600">Manage your personal details and preferences.</p>
                </div>

            </div>

            @if(session('success'))
                <div class="p-4 bg-green-100 border border-green-200 rounded-xl text-green-700 text-sm">
                    {{ session('success') }}
                </div>
            @endif
            @if($errors->any())
                <div class="p-4 bg-red-100 border border-red-200 rounded-xl text-red-700 text-sm">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200 shadow-sm space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid gap-6 lg:grid-cols-[220px_1fr]">
                    <aside class="border-b border-gray-200 pb-4 lg:border-b-0 lg:border-r lg:border-gray-200 lg:pb-0 lg:pr-4">
                        <nav class="space-y-1" role="tablist">
                            <button type="button" class="tab-btn w-full flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold text-amber-600 bg-amber-50 transition" data-tab="general">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                            </svg>
                                Account Information
                            </button>
                            <button type="button" class="tab-btn w-full flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-100 transition" data-tab="security">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                            </svg>
                                Change Password
                            </button>
                            <button type="button" class="tab-btn w-full flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-100 transition" data-tab="address">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <button type="button" class="tab-btn w-full flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-100 transition" data-tab="notifications">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
                            </svg>
                                Notification
                            </button>
                            <button type="button" class="tab-btn w-full flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-100 transition" data-tab="rewards">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                            </svg>
                                Rewards
                            </button>
                            <button type="button" class="tab-btn w-full flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-100 transition" data-tab="deactivate">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <div class="space-y-6">
                        <div class="tab-panel" data-panel="general">
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" name="first_name" value="{{ $firstName }}" required
                                            class="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-colors">
                                    </div>
                                    <div>
                                ...
                                <div>
                                    <label for="email_display" class="block text-sm font-medium text-gray-600 mb-2">Email</label>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input id="profile-current-password" type="password" name="current_password" autocomplete="current-password"
                                            class="w-full px-4 py-3 pr-11 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-colors">
                        ...
                        <div class="tab-panel hidden" data-panel="address">
                            <div class="space-y-3">
                                <label class="block text-sm font-medium text-gray-600">Default Shipping Address (Metro Manila Only)</label>
                                ...
                                <select id="city" name="shipping_city" required
                                    class="w-full bg-white border border-gray-300 rounded-xl p-3 text-gray-900 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-colors">
                                ...
                                <input type="text" name="shipping_country"
                                    value="Philippines"
                                    readonly
                                    class="w-full mt-3 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-500 cursor-not-allowed">
                            </div>
                        </div>
                        ...
                        <div class="tab-panel hidden" data-panel="notifications">
                            <div class="space-y-3">
                                <label class="flex items-center gap-3 text-sm text-gray-700">
                                    ...
                                    <input type="checkbox" name="notify_order_updates" value="1" class="h-4 w-4 rounded border-gray-300 bg-white text-amber-500" {{ old('notify_order_updates', $user->notify_order_updates) ? 'checked' : '' }}>
                                    Notify me about order updates (shipped or delivered)
                                </label>
                                <label class="flex items-center gap-3 text-sm text-gray-700">
                                    <input type="hidden" name="notify_promotions" value="0">
                                    <input type="checkbox" name="notify_promotions" value="1" class="h-4 w-4 rounded border-gray-300 bg-white text-amber-500" {{ old('notify_promotions', $user->notify_promotions) ? 'checked' : '' }}>
                                    Send me promotions and offers
                                </label>
                                <label class="flex items-center gap-3 text-sm text-gray-700">
                                    <input type="hidden" name="notify_loyalty" value="0">
                                    <input type="checkbox" name="notify_loyalty" value="1" class="h-4 w-4 rounded border-gray-300 bg-white text-amber-500" {{ old('notify_loyalty', $user->notify_loyalty) ? 'checked' : '' }}>
                        ...
                        <div class="tab-panel hidden" data-panel="rewards">
                            <div class="space-y-3">
                                <div class="flex items-center justify-between bg-gray-50 rounded-xl border border-gray-200 px-4 py-3">
                                    <span class="text-sm text-gray-600">Points Balance</span>
                                    <span class="text-amber-600 font-bold">{{ $user->points_balance }} pts</span>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-600 mb-2">Referral Link</label>
                                    <input type="text" readonly value="{{ url('/register') }}?ref={{ $user->id }}" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-500 cursor-not-allowed">
                        ...
                        <div class="tab-panel hidden" data-panel="deactivate">
                            <div class="space-y-3">
                                ...
                                <p class="text-sm text-gray-600">Temporarily disable your account. You can contact support to reactivate it later.</p>
                                <button type="button" onclick="showDeactivateModal()" class="w-full sm:w-auto px-6 py-3 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 transition-colors font-semibold">
                                    Deactivate Account
                                </button>
                            </div>
                        </div>
                ...
                <div class="flex flex-col gap-3 pt-4 sm:flex-row sm:justify-end">
                    ...
                    <a href="{{ route('profile.show') }}" class="px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 border border-gray-200 text-center transition-colors">
                        Cancel
                    </a>
                </div>
            </form>
            ...
            <div id="deactivateModal" class="fixed inset-0 z-50 hidden" aria-labelledby="deactivate-title" role="dialog" aria-modal="true">
                ...
                <div class="fixed inset-0 z-10 flex items-center justify-center p-4">
                    <div class="w-full max-w-md rounded-2xl bg-white text-gray-900 border border-gray-200 shadow-xl">
                        <div class="p-6">
                            <h3 id="deactivate-title" class="text-lg font-semibold">Are you sure you want to deactivate your account?</h3>
                            <p class="mt-2 text-sm text-gray-600">This will disable your account. You can contact support to reactivate it later.</p>
                        ...
                        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100">
                            <button type="button" onclick="hideDeactivateModal()" class="px-4 py-2 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200">Cancel</button>
    ...
    (function () {
        ...
        function activateTab(tab) {
            buttons.forEach(btn => {
                ...
                if (!isActive) btn.classList.remove('bg-amber-50');
            });
