                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-6 gap-2 text-sm">
                        ...
                        <div>
                            <div class="flex items-center justify-center">
                             <button type="button" data-open-order-modal="{{ $modalId }}" title="View Details" class="inline-flex items-center justify-center px-3 py-1.5 bg-amber-300 hover:bg-amber-400 text-black font-bold rounded-lg text-xs transition-colors">
