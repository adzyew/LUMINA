                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4 sm:space-x-6">
                        ...
                        <div class="hidden md:flex items-center space-x-4">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="text-amber-300 font-medium">My Account</a>
                            @else
                                <a href="{{ route('login.form') }}" class="text-gray-300 hover:text-amber-300 font-medium">Login</a>
                                <a href="{{ route('register.form') }}" class="px-5 py-2 bg-amber-300 text-black font-bold rounded-lg hover:bg-amber-400 transition-colors">Sign Up</a>
                            @endauth
                        </div>
